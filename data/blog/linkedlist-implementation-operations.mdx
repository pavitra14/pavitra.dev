...
date: '2021-04-03'
lastmod: '2021-04-03'
tags: ['c++', 'LinkedList', 'DSA', 'design-patterns']
summary: 'Linked List Data Structure Implementation and Operations in best time complexities'
---
...
A Linked list is a common data structure made of chain of nodes, in which each node contains two fields, _data_ which holds the data and _next_ which holds the address to next node in the chain.
